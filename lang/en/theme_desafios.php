...
$string['choosereadme'] = 'desafios is a three column theme for Moodle 2.9+ originally created by Shaun Daubney for <a href="http://www.newbury-college.ac.uk">Newbury College</a> based on Bootstrap. Older versions are available for Moodle 2.8 and below.';
$string['colourheading'] = 'Colours and Background';
$string['colourheadingdesc'] = 'Customise site colours and background image.';
$string['configtitle'] = 'desafios';
